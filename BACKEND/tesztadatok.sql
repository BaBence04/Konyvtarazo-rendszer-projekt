...
('9783161484100', 'Learning SQL', 1, '2020-08-15', 2, 'A guide to learning SQL', NULL),
('9783161484201', 'Mastering Databases', 2, '2019-05-21', 1, 'Comprehensive guide to databases', NULL);
...
INSERT INTO users (surname, first_name, birth_date, membership_end_date, email, phone_number, password, birh_place, address, mother_maiden_name, active) VALUES
('Kovács', 'János', '1985-03-15', '2025-03-15', 'janos.kovacs@example.com', '06123456789', 'password', 'Budapest', '123 Main St', 'Nagy Erzsébet', TRUE),
('Szabó', 'Anna', '1990-10-22', '2025-10-22', 'anna.szabo@example.com', '06789123456', 'password', 'Debrecen', '456 High St', 'Kiss Júlia', TRUE);
