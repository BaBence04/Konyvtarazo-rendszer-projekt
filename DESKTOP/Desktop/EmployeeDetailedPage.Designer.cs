namespace Desktop
{
    partial class EmployeeDetailedPage
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cdgvEmployees.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.cdgvEmployees.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
			...
			this.cdgvEmployees.DefaultCellStyle = dataGridViewCellStyle8;
			...
			this.cdgvEmployees.RowHeadersDefaultCellStyle = dataGridViewCellStyle9;
			this.cdgvEmployees.RowHeadersWidth = 51;
			dataGridViewCellStyle10.Padding = new System.Windows.Forms.Padding(5);
			this.cdgvEmployees.RowsDefaultCellStyle = dataGridViewCellStyle10;
